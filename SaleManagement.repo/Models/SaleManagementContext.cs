...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    public string GetAdminEmail() {
        IConfiguration config = new ConfigurationBuilder()
            ...
            .AddJsonFile("appsettings.json", true, true)
            .Build();
        var strEmail = config["AdminAccount:AdminEmail"];
        return strEmail;
    }
    public string GetAdminPassword()
    {
        IConfiguration config = new ConfigurationBuilder()
            ...
            .AddJsonFile("appsettings.json", true, true)
            .Build();
        var strPass = config["AdminAccount:AdminPassword"];
        return strPass;
    }
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__Member__0CF04B1837FDFD87");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BCF481EE55E");
        ...
        {
            entity.HasKey(e => new { e.ProductId, e.OrderId }).HasName("PK__OrderDet__5835C371838F9D1A");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__B40CC6CD43EC73E8");
